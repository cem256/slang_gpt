...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	String get app_title => 'Slang GPT';
	String get intro_title => 'Welcome to Slang GPT';
	String get intro_description => 'This application demonstrates the usage of the slang_gpt package for Flutter apps.';
...
class _StringsTr extends Translations {
	...
	// Translations
	@override String get intro_title => 'Slang GPT\'ye Hoş Geldiniz';
	@override String get intro_description => 'Bu uygulama, Flutter uygulamaları için slang_gpt paketinin kullanımını göstermektedir.';
	@override String get highlight_title => 'Bağlama Duyarlı Çeviriler Oluşturun';
	@override String get highlight_description => 'GPT ile bağlama duyarlı çeviriler oluşturun';
	@override Map<String, String> get locales => {
		'en': 'İngilizce',
		'tr': 'Türkçe',
		'ar': 'Arapça',
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'app_title': return 'Slang GPT';
			case 'intro_title': return 'Welcome to Slang GPT';
			case 'intro_description': return 'This application demonstrates the usage of the slang_gpt package for Flutter apps.';
...
extension on _StringsTr {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'intro_title': return 'Slang GPT\'ye Hoş Geldiniz';
			case 'intro_description': return 'Bu uygulama, Flutter uygulamaları için slang_gpt paketinin kullanımını göstermektedir.';
			case 'highlight_title': return 'Bağlama Duyarlı Çeviriler Oluşturun';
